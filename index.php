...
<div class="container-fluid main-container">
    ...
    <div class="row">
        <div class="col-md-3 col-3 offset-1 newly-post-index"><a href="./works/graphic.php"><h1>GRAPHIC</h1><span><img src="../images/new.png"></span></a></div>
        <div class="col-md-4 col-4 newly-post-index"><a href="./works/package.php"><h1>PACKAGE</h1><span><img src="../images/new.png"></span></a></div>
        <div class="col-md-3 col-3"><a href="./works/webdesign.php"><h1>WEB</h1></a></div>
    </div>
    <div class="row">
